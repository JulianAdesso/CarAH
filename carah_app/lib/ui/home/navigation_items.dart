...
final List<ListItem> homeItemsList  = [
  ListItem(title: 'Tokoloho Articles', description: 'Lipsum', icon: Icons.article_outlined, routerLink: '/articles_categories', availableInOfflineMode: true),
  ...
  ListItem(title: 'Events', description: 'Lipsum', icon: Icons.event_outlined, routerLink: '/events', availableInOfflineMode: false),
  ListItem(title: 'Medicine pick up dates', description: 'Lipsum', icon: Icons.medication_outlined, routerLink: '/pick_up_dates', availableInOfflineMode: false)
];
