...
final router = GoRouter(
  routes: [
    ...
    GoRoute(path: '/faqs/:id',
        builder: (context, state) => SubcategoryWidget<Question, QuestionsProvider>(id: state.params['id']!, path: 'faq', title: 'Questions',)),
    GoRoute(path: '/faq/:id',
    ...
    GoRoute(path: '/guidelines/:id',
        builder: (context, state) => GuidelinesCategoryWidget(id: state.params['id']!)),
