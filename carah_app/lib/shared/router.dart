...
final router = GoRouter(
  routes: [
    ...
    GoRoute(path: '/faq_categories',
        builder: (context, state) => const CategoryWidget(path: 'faqs', type: 'faq_category', title: 'FAQ Categories', categoryUUID: 'b46628c6bc284debbd2ab8c76888a850')),
    GoRoute(path: '/faqs/:id',
        builder: (context, state) => SubcategoryWidget<Question, QuestionsProvider>(id: state.params['id']!, path: 'faq', title: 'FAQ',)),
    GoRoute(path: '/faq/:id',
